/* ArenaMind - Mock Datasets and Knowledge Base */

const ARENA_DATA = {
  // Live and upcoming match lists
  matches: [
  ...
  // Wait times at concessions, services, restrooms
  services: [
  ...
  // Multilingual GenAI QA Knowledge Base for interactive chat
  qaDatabase: {
    en: [
      {
  ...
  // Operational incident records for venue staff
  incidents: [
    {
      id: "inc-101",
      type: "Hardware",
  ...
  // Simulation scenario parameters and outcomes
  simulations: {
    thunderstorm: {
